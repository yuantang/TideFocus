    ...
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50 p-4">
      <div className="rounded-lg shadow-xl p-6 sm:p-8 w-11/12 max-w-md relative" style={{ backgroundColor: BG_COLOR, color: TEXT_COLOR }} onClick={(e) => e.stopPropagation()}>
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">What is your focus?</h2>
          <p className="opacity-70 mb-6">Set an intention, or choose a task to link.</p>
          ...
          <div className="space-y-4">
             {tasks.length > 0 && (
                ...
                >
                    <option value="">Or select a task...</option>
                    {tasks.map(task => (
